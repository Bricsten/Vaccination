...
import { FaBars, FaAngleDoubleLeft, FaHome, FaUserCheck, FaSignOutAlt, FaCog, FaGlobe } from 'react-icons/fa';
        ...
        <>
            <div className=" flex-grow-1 d-flex bg-success">
                ...
                <div className={'overflow-y-auto panel z-3 bg-success ' + (isOpen ? 'openPanel' : '')}>
                    ...
                    <Link to="/" className={'ms-auto mt-3 text-white fw-bolder d-flex align-items-center gap-3 ps-2 py-2 text-decoration-none '} style={{ fontSize: 17, width: '260px' }}>
                        <FaGlobe />
                        <span>Visit Website</span>
                    </Link>
                    <Link to="/" onClick={() => { localStorage.clear() }} className={'ms-auto btn mt-5 text-white fw-bolder d-flex align-items-center gap-3 ps-2 py-2 text-decoration-none '} style={{ fontSize: 17, width: '260px' }}>
                        <FaSignOutAlt />
                        <span>Log Out</span>
                    </Link>
                </div>
